...
import Productitem from '@/components/ProductsMossor/Productitem'
import { cn } from '@/utils/utils'

const ProductsMossor = ({ title, categories, prodTitle, prodText, post }) => {
