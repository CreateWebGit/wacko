    ...
    return (
        <footer>
            <div className="top-container">
                <div className="wacko-container">
                    <img src="img/wacko_logo_black.svg"/>
                    <div className="contact-container">
                        <div className="item-title">Götgatan 35, 116 21 Stockholm</div>
                        <div className="item-title">08-411 15 53 <br/><br/></div>
                        <div className="item-title">MÅN - FRE: 11:00 &mdash; 18:00 <br/>LÖR: 11:00 &mdash; 16:00 <br/>SÖN: Stängt</div>
                    </div>
                </div>
            ...
            <div className="bottom-container">
                <div className="item-title">
                    <div className="content">
                        ...
                        <div className="createweb"><a href="https://createweb.se" target="_blank">Skapad av CreateWeb</a></div>
